export const PROJECTS = [
    ...
    },
    {
      ...
      star: {
        s: 'Cafe24 기반 쇼핑몰을 운영하면서, 신규 "ㅋㅋㅋTV" 페이지 구축이랑 백오피스 개발이 동시에 필요한 상황이었습니다.',
        t: '게임형 이벤트 월 1회 정기 제작, "ㅋㅋㅋTV" 페이지 구축, React 백오피스 설계 및 API 연동을 담당했습니다.',
        a: 'CSS·JavaScript로 게임형 이벤트를 구현하고, React로 백오피스를 직접 설계해서 Cafe24 와 연동했습니다. 콘텐츠 등록·관리 기능까지 직접 구현했습니다.',
        r: '운영자가 콘텐츠를 직접 관리할 수 있는 운영 환경을 만들어 운영 공수를 30% 줄였습니다.',
      },
      troubleshooting: [
        {
          tag: 'Routing',
    ...
    },
    {
      ...
      star: {
        ...
        t: '쇼핑몰과 백오피스를 안정적으로 구축하고, API 기반 운영 환경을 구현해야 했습니다.',
